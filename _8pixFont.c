 ...
 * Fonts
 * -----
 * _8pixFont - Height: 8 pixels, 1 bit per pixel, Range: ' ' to '~'
 *****************************************************************************/
...
extern GFX_FONT_SPACE char ___8pixFont[] __attribute__((section("grc_text"), aligned(2)));
#else
extern GFX_FONT_SPACE char ___8pixFont[] __attribute__((aligned(2)));
#endif

const FONT_FLASH _8pixFont =
{
    (FLASH | COMP_NONE),
    (GFX_FONT_SPACE char *)___8pixFont
};
